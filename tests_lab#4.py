...
c = ""

a = list(map(int, a))
b = list(map(int, b))
c = list(map(int, c))
deg = (1 << m) - 1
deg = [int(bit) for bit in bin(deg)[2:]]
one = [1] * m
...
# Тест2 с^(2^m-1)=1 
result_power = field.power(c, deg)
